    ...
    if(isset($submit)) {
        if($submit == 0) {
            ...
            if(!isset($requests)) {
                ...
                if(empty($errors)) {
                    foreach($requests as $request) {
                        denyFriendRequest($userId, $request);
                    }
                }
            }
        }
    ...
    <div class="card mt-3 mx-auto" style="width: 55rem;">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" value="Submit" name="defriend" class="btn mt-3" style="background-color: DarkSlateBlue; color: white;">Defriend Selected</button>
            </div>
        </form>
        </div>
    </div>
    ...
    <div class="card mt-3 mx-auto" style="width: 55rem;">
        ...
        <form action="MyFriends.php" method="post">
            ...
            <div class="mt-3 d-flex justify-content-end">
                <button name="submit" value="0" class="btn me-2" id="acceptRequest" style="background-color: DarkSlateBlue; color: white;" onclick="submitWithoutConfirm(this)">Accept Selected</button>
                <button name="submit" value="1" class="btn btn-outline-secondary" onclick="confirmDeny(event)">Deny Selected</button>
            </div>
        </form>
        </div>
    </div>
